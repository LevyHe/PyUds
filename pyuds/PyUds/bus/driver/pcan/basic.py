...
class PCANStatusError(Exception):
    str_lud = {
    ...
    def __str__(self):
        if self.status in PCANStatusError.str_lud:
            errstr = PCANStatusError.str_lud[self.status]
        else:
            errstr = "No translation available"
        return "%s failed with status %d (%s)" % (self.funcrepr, self.status, errstr)


class PCANBasicError(Exception):
    pass
...
class PCANBasic:
    ...
    def __init__(self):
        try:
            DLL_NAME = 'PCANBasic_nt_amd64_64bit.dll' if platform.architecture()[0] == '64bit' else 'PCANBasic_nt_amd64_32bit.dll'
            dll_path = os.path.join(os.path.dirname(__file__), DLL_NAME)
            self.__m_dllBasic = ctypes.windll.LoadLibrary(dll_path)
        except:
            # try:
            #     DLL_NAME = 'PCANBasic' if platform.architecture()[
            #         0] == '64bit' else 'vxlapi'
            ...
            # except:
            raise Exception('Could not load PCANBasic dll file')
        ...
        #     raise PCANBasicError("Exception: The PCAN-Basic DLL couldn't be loaded!")
    ...
    def Initialize(
        ...
        try:
            ...
            raise PCANBasicError("Exception on PCANBasic.Initialize")
    ...
    Remarks:
      See PCAN_BR_* values.
        ...
        try:
            ...
            raise PCANBasicError("Exception on PCANBasic.InitializeFD")
    ...
    def Uninitialize(
        ...
        try:
            ...
            raise PCANBasicError("Exception on PCANBasic.Uninitialize")
    ...
    def Reset(
        ...
        try:
            ...
            raise PCANBasicError("Exception on PCANBasic.Reset")
    ...
    def GetStatus(
        ...
        try:
            ...
            raise PCANBasicError("Exception on PCANBasic.GetStatus")
    ...
    def Read(
        ...
        try:
            ...
            raise PCANBasicError("Exception on PCANBasic.Read")
    ...
    def ReadFD(
        ...
        try:
            ...
            raise PCANBasicError("Exception on PCANBasic.ReadFD")
    ...
    def Write(
        ...
        try:
            ...
            raise PCANBasicError("Exception on PCANBasic.Write")
    ...
    def WriteFD(
        ...
        try:
            ...
            raise PCANBasicError("Exception on PCANBasic.WriteFD")
    ...
    def FilterMessages(
        ...
        try:
            ...
            raise PCANBasicError("Exception on PCANBasic.FilterMessages")
    ...
    def GetValue(
        ...
        try:
            ...
            raise PCANBasicError("Exception on PCANBasic.GetValue")
    ...
    def SetValue(
        ...
        try:
            ...
            raise PCANBasicError("Exception on PCANBasic.SetValue")
    ...
    def GetErrorText(
        ...
        try:
            ...
            raise PCANBasicError("Exception on PCANBasic.GetErrorText")
